#Keeping two modules in the same files is crappy and fugly, so this is its own
defmodule Converter do
	...
	def to_light_seconds({:miles, miles} = val, precision) do
		(miles * 3.36819e-6) |> round_to(precision)
	end
